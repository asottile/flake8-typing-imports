...
SYMBOLS = (
    ...
    (
        Version(3, 5, 2), frozenset((
            ...
            'DefaultDict', 'Dict', 'Generator', 'Generic', 'Hashable', 'IO',
    ...
    (
        Version(3, 5, 3), frozenset((
            'AbstractSet', 'Any', 'AnyStr', 'BinaryIO', 'ByteString',
            'Callable', 'ClassVar', 'Container', 'DefaultDict', 'Dict',
    ...
    (
        Version(3, 5, 4), frozenset((
            'AbstractSet', 'Any', 'AnyStr', 'BinaryIO', 'ByteString',
            'Callable', 'ClassVar', 'Container', 'ContextManager', 'Counter',
            'DefaultDict', 'Deque', 'Dict', 'FrozenSet', 'Generator',
            'Generic', 'GenericMeta', 'Hashable', 'IO', 'ItemsView',
            'Iterable', 'Iterator', 'KeysView', 'List', 'Mapping',
            'MappingView', 'Match', 'MutableMapping', 'MutableSequence',
            'MutableSet', 'NamedTuple', 'NewType', 'Optional', 'Pattern',
            'Reversible', 'Sequence', 'Set', 'Sized', 'SupportsAbs',
    ...
    (
        Version(3, 6, 1), frozenset((
            'AbstractSet', 'Any', 'AnyStr', 'BinaryIO', 'ByteString',
            'Callable', 'ClassVar', 'Container', 'Counter', 'DefaultDict',
            'Deque', 'Dict', 'FrozenSet', 'Generator', 'Generic',
            'GenericMeta', 'Hashable', 'IO', 'ItemsView', 'Iterable',
            ...
            'Sized', 'SupportsAbs', 'SupportsFloat', 'SupportsInt',
            'SupportsRound', 'TYPE_CHECKING', 'Text', 'TextIO', 'Tuple',
            'Type', 'TypeVar', 'Union', 'ValuesView', 'cast', 'get_type_hints',
            'no_type_check', 'no_type_check_decorator', 'overload',
        )),
    ...
    (
        Version(3, 7, 0), frozenset((
            ...
            'BinaryIO', 'ByteString', 'Callable', 'ClassVar', 'Collection',
            'Container', 'ContextManager', 'Coroutine', 'Counter',
            'DefaultDict', 'Deque', 'Dict', 'FrozenSet', 'Generator',
            'Generic', 'Hashable', 'IO', 'ItemsView', 'Iterable', 'Iterator',
            'KeysView', 'List', 'Mapping', 'MappingView', 'Match',
            'MutableMapping', 'MutableSequence', 'MutableSet', 'NamedTuple',
            'NewType', 'NoReturn', 'Optional', 'Pattern', 'Reversible',
...
class Plugin:
    ...
    _min_python_version = Version(3, 5)
